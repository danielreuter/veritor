...
class Expectation:
    ...
    canonical zero-padded encoding); ``policy`` is the client's ``theta
    ...
    in output order, the check outputs among them at their constants; the
    verifier encodes them with the circuit's canonical codec.
...
class VerifierSession:
    ...
    def _admit(self) -> None:
        ...
        length (the expectation has checked the encoding is canonical); when the
        ...
        advice_bits = self._expectation.advice_bits

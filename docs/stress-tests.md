...
| S2a | scale, RequestsG: 1,000 requests of 98 shapes (Zipf-like prompts, bimodal generation) | M1 | 0 | 30,392 | 0.609 | 306,134 | description 306,134 B; trace < 1 s, compile < 1 s, kind table < 1 s, bound < 10 s |
| S2b | scale, RequestsG: 10,000 requests of 119 shapes (Zipf-like prompts, bimodal generation) | M1 | 0 | 31,530 | 0.609 | 339,452 | description 339,452 B; trace < 1 s, compile < 1 s, kind table < 1 s, bound < 10 s |
| S2c | scale, RequestsG: 100,000 requests of 119 shapes (Zipf-like prompts, bimodal generation) | M1 | 0 | 32,435 | 0.609 | 339,808 | description 339,808 B; trace < 1 s, compile < 1 s, kind table < 1 s, bound < 10 s |

...
| S2a | scale, RequestsG: 1,000 requests of 98 shapes (Zipf-like prompts, bimodal generation) | M1 | 0 | 30,392 | 0.889 | 306,134 | description 306,134 B, trace 36 ms, compile 43 ms, kind table 20 ms, bound 1215 ms |
| S2b | scale, RequestsG: 10,000 requests of 119 shapes (Zipf-like prompts, bimodal generation) | M1 | 0 | 31,530 | 0.889 | 339,452 | description 339,452 B, trace 57 ms, compile 48 ms, kind table 22 ms, bound 2394 ms |
| S2c | scale, RequestsG: 100,000 requests of 119 shapes (Zipf-like prompts, bimodal generation) | M1 | 0 | 32,435 | 0.889 | 339,808 | description 339,808 B, trace 255 ms, compile 49 ms, kind table 22 ms, bound 5048 ms |
